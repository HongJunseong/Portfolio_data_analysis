...
DATA_DIR = "./data"  # 사고 유형별 폴더가 있는 폴더
OUTPUT_DIR = "./processed_data"  # 프레임 저장 폴더

# 모든 "VS_" 폴더 탐색
video_folders = [os.path.join(DATA_DIR, f) for f in os.listdir(DATA_DIR) if f.startswith("VS_") and os.path.isdir(os.path.join(DATA_DIR, f))]
